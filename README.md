...
Look at games.txt for all games and knowledge_types.csv for 800 annotations of knowledge types. These are arrange chronologically so each 4 rows = 1 game
